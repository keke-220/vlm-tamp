...
root_path = "datasets/tpvqa_dalle_v0/serve_breakfast/"
task_path = "datasets/tpvqa_dalle_v0/serve_breakfast/"
actions = ['find_bread', 'pickup_bread', 'find_plate', 'placeon_bread_plate', 'find_tv', 'turnon_tv']
actions = ['find_bread', 'pickup_bread', 'find_plate', 'placeon_bread_plate']
image_cls = ['0', '2'] 
unknown = ['xxx', 'yyy', 'zzz']
...
prev_ac = {
        'pickup_bread': 'find_bread',
        'placeon_bread_plate': 'pickup_bread',
        'turnon_tv': 'find_tv',
        }
